...
$(function() {
	...
	$(window).on("scroll", function() {
		...
		if(winScr>0) {
	      $('header').removeClass('slideIn animated');
	      $('header').addClass('scrolled slideInDown animated');
	    }
	    else {
	      $('header').removeClass('scrolled slideInDown animated');
	...
	$('.cmn-toggle-switch').on('click', function(e){
		...
		$('.heroJumbo').slideToggle();
		console.log("Sterling Baldwin");
		e.preventDefault();
	});
